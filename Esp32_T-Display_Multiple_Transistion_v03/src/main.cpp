...
const char *PROGRAM_VERSION = "ESP32 LilyGo TTGO T-Display ST7789 1.14-inches display 135x240 px Adafruit ST7735 and TFT_eSPI libraries V03";
const char *COUNTER_NAME = "P Counter:";

// ---------------------------------------------------------------------------------------------------
// Display library settings

#if defined(TYPE_ADAFRUIT)
